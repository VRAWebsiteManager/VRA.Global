...
INDUSTRIES = [
    ...
    },
    {
        ...
        "meta_description": "Hire a virtual assistant trained for title and escrow work — closing coordination, document prep, and client updates. Flat-rate pricing, hands-on matching, no long trial periods.",
        ...
        "why_card1": "Only the top 1% of applicants make it through our screening and mandatory 28-day training program — covering document preparation, e-signature workflows in dotloop and DocuSign, and closing-file organization — before they ever touch client work. Because mastering one industry workflow means picking up another quickly, we commit to having every VA fluent in whatever title production software or CRM you use within 5 days of hire.",
    ...
    },
    {
        ...
        "meta_description": "Hire a virtual assistant trained for mortgage and lending work — loan file organization, borrower communication, and appointment scheduling. Flat-rate pricing, no long trial periods.",
        ...
        "why_card1": "Only the top 1% of applicants make it through our screening and mandatory 28-day training program — covering document preparation, e-signature workflows in dotloop and DocuSign, and file organization — before they ever touch client work. Because mastering one industry workflow means picking up another quickly, we commit to having every VA fluent in whatever loan origination system or CRM you use within 5 days of hire.",
        "service_intro": "Every VRA mortgage &amp; lending VA is trained on the day-to-day of a loan file — not just general admin.",
        "service_bullets": [
            "Loan file organization and document tracking",
